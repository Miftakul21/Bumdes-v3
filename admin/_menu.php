	...
	while ($data=mysqli_fetch_assoc($result)) {
		...
		<li class="nav-item has-treeview">
			...
			<ul class="nav nav-treeview text-light">
				...
				<li class="nav-item">
					<a href="?hal=lap_buku_besar&id=<?=$id_unit;?>" class="nav-link text-light"> 
						<i class="fa fa-book nav-icon"></i>
						<p>Buku Besar</p>
					</a>
				</li>
				<li class="nav-item">
					<a href="?hal=lap_arus_kas&id=<?=$id_unit;?>" class="nav-link text-light"> 
						<i class="fa fa-angle-double-right nav-icon"></i>
						<p>Arus Kas</p>
					</a>
				</li>
				<li class="nav-item">
					<a href="?hal=lap_laba_rugi&id=<?=$id_unit;?>" class="nav-link text-light"> 
						<i class="fa fa-credit-card nav-icon"></i>
						<p>Laba Rugi</p>
					</a>
				</li>
				<li class="nav-item">
					<a href="?hal=lap_perubahan_modal&id=<?=$id_unit;?>" class="nav-link text-light"> 
						<i class="fa fa-low-vision nav-icon"></i>
						<p>Perubahan Modal</p>
					</a>
				</li>
				<li class="nav-item">
					<a href="?hal=lap_neraca&id=<?=$id_unit;?>" class="nav-link text-light"> 
						<i class="fa fa-balance-scale nav-icon"></i>
						<p>Neraca</p>
					</a>
				</li>
